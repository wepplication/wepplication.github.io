...
teaser: "CentOS 7에 Bitnami Redmine 설치 및 플러그인, 테마 적용하기"
categories:
    - software
tags:
    - opensource
...
- Gmail 보안설정에서 보안 수준이 낮은 앱에 대한 계정 액세스 변경을 설정
 [https://support.google.com/accounts/answer/6010255?hl=ko](https://support.google.com/accounts/answer/6010255?hl=ko){:target="_blank"}  
...
{% include list-posts category='software' %}